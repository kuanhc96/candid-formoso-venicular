...
public interface MazeCarver {
    ...
    default Maze generateMaze(Maze initialMaze) {
        ...
        */
        ...
        ISet<Wall> removableWalls = initialMaze.getRemovableWalls();
        ISet<Wall> unremovableWalls = initialMaze.getUnremovableWalls();
        ...
        // for some reason, non  of the walls in toRemove were taken from removableWalls.
        // toRemove does not contain any of the removableWalls
